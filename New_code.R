...
km_trt_titles <- survfit(Surv(Data1_alt$races_for_team, Data1_alt$last_alt)~Data1_alt$anytitles)
autoplot(km_trt_titles) 

gehan.wilcoxon.test(Surv(Data1_alt$races_for_team, Data1_alt$last_alt)~Data1_alt$anytitles, Data1_alt, gehan = TRUE)
...
km_trt_wins <- survfit(Surv(Data1_alt$races_for_team, Data1_alt$last_alt)~Data1_alt$anywins)
autoplot(km_trt_wins) 

gehan.wilcoxon.test(Surv(Data1_alt$races_for_team, Data1_alt$last_alt)~Data1_alt$anywins, Data1_alt, gehan = TRUE)
...
km_trt_poles <- survfit(Surv(Data1_alt$races_for_team, Data1_alt$last_alt)~Data1_alt$anypoles)
autoplot(km_trt_poles) 

gehan.wilcoxon.test(Surv(Data1_alt$races_for_team, Data1_alt$last_alt)~Data1_alt$anypoles, Data1_alt, gehan = TRUE)
...
km_trt_podiums <- survfit(Surv(Data1_alt$races_for_team, Data1_alt$last_alt)~Data1_alt$anypodiums)
autoplot(km_trt_podiums) 

gehan.wilcoxon.test(Surv(Data1_alt$races_for_team, Data1_alt$last_alt)~Data1_alt$anypodiums, Data1_alt, gehan = TRUE)
...
km_trt_points <- survfit(Surv(Data1_alt$races_for_team, Data1_alt$last_alt)~Data1_alt$anypoints)
autoplot(km_trt_points) 

gehan.wilcoxon.test(Surv(Data1_alt$races_for_team, Data1_alt$last_alt)~Data1_alt$anypoints, Data1_alt, gehan = TRUE)
...
km_trt_history <- survfit(Surv(Data1_alt$races_for_team, Data1_alt$last_alt)~Data1_alt$History)
autoplot(km_trt_history)

survdiff(Surv(Data1_alt$sum_seasons_alt, Data1_alt$last_alt)~Data1_alt$History, data = Data1_alt)
gehan.wilcoxon.test(Surv(Data1_alt$races_for_team, Data1_alt$last_alt)~Data1_alt$History, Data1_alt, gehan = TRUE)
...
km_trt_factory <- survfit(Surv(Data1_alt$races_for_team, Data1_alt$last_alt)~Data1_alt$Factory)
autoplot(km_trt_factory)

gehan.wilcoxon.test(Surv(Data1_alt$races_for_team, Data1_alt$last_alt)~Data1_alt$Factory, Data1_alt, gehan = TRUE)


#Чемпион младших серий (значимо для сезонов на 10%, незначимо для гонок)
...
gehan.wilcoxon.test(Surv(Data1_alt$sum_seasons_alt, Data1_alt$last_alt)~Data1_alt$F2_GP2_F3000_champ, Data1_alt, gehan = TRUE)
survdiff(Surv(Data1_alt$sum_seasons_alt, Data1_alt$last_alt)~Data1_alt$F2_GP2_F3000_champ, data = Data1_alt)


km_trt_F2 <- survfit(Surv(Data1_alt$races_for_team, Data1_alt$last_alt)~Data1_alt$F2_GP2_F3000_champ)
autoplot(km_trt_F2)

gehan.wilcoxon.test(Surv(Data1_alt$races_for_team, Data1_alt$last_alt)~Data1_alt$F2_GP2_F3000_champ, Data1_alt, gehan = TRUE)


#Спортивная династия (по сезонам значимо, по гонкам - нет)
...
km_trt_family <- survfit(Surv(Data1_alt$races_for_team, Data1_alt$last_alt)~Data1_alt$Family_business)
autoplot(km_trt_family)

gehan.wilcoxon.test(Surv(Data1_alt$races_for_team, Data1_alt$last_alt)~Data1_alt$Family_business, Data1_alt, gehan = TRUE)


#Совпадение гражданства (не значимо!)
...
km_trt_nation <- survfit(Surv(Data1_alt$races_for_team, Data1_alt$last_alt)~Data1_alt$driver_team_nation)
autoplot(km_trt_nation)

gehan.wilcoxon.test(Surv(Data1_alt$races_for_team, Data1_alt$last_alt)~Data1_alt$driver_team_nation, Data1_alt, gehan = TRUE)
...
km_trt_married <- survfit(Surv(Data1_alt$races_for_team, Data1_alt$last_alt)~Data1_alt$married)
autoplot(km_trt_married)

gehan.wilcoxon.test(Surv(Data1_alt$races_for_team, Data1_alt$last_alt)~Data1_alt$married, Data1_alt, gehan = TRUE)
...
km_trt_kids <- survfit(Surv(Data1_alt$races_for_team, Data1_alt$last_alt)~Data1_alt$children)
autoplot(km_trt_kids)

gehan.wilcoxon.test(Surv(Data1_alt$races_for_team, Data1_alt$last_alt)~Data1_alt$children, Data1_alt, gehan = TRUE)
...
km_trt_partner <- survfit(Surv(Data1_alt$races_for_team, Data1_alt$last_alt)~Data1_alt$beatpartner)
autoplot(km_trt_partner)

gehan.wilcoxon.test(Surv(Data1_alt$races_for_team, Data1_alt$last_alt)~Data1_alt$beatpartner, Data1_alt, gehan = TRUE)
...
#Про пропорциональность рисков (не выполняется)
cox.zph(Cox_mod_AIC) 
ggcoxzph(cox.zph(Cox_mod_AIC))
?cox.zph
...
#Про линейность
ggcoxfunctional(Surv(Data1_alt$sum_seasons_alt, Data1_alt$last_alt) ~ age + log(age) + sqrt(age), data = Data1_alt)
ggcoxfunctional(Surv(Data1_alt$sum_seasons_alt, Data1_alt$last_alt) ~ winpr + sqrt(winpr), data = Data1_alt)
ggcoxfunctional(Surv(Data1_alt$sum_seasons_alt, Data1_alt$last_alt) ~ pointpr + sqrt(pointpr), data = Data1_alt)
ggcoxfunctional(Surv(Data1_alt$sum_seasons_alt, Data1_alt$last_alt) ~ titleps + sqrt(titleps), data = Data1_alt)
ggcoxfunctional(Surv(Data1_alt$sum_seasons_alt, Data1_alt$last_alt) ~ gainedpr, data = Data1_alt)
ggcoxfunctional(Surv(Data1_alt$sum_seasons_alt, Data1_alt$last_alt) ~ mean_share_of_points_team + sqrt(mean_share_of_points_team), data = Data1_alt)
...
Cox_mod_breslow <- coxph(Surv(sum_seasons_alt, last_alt) ~ F2_GP2_F3000_champ +
                           children +
                           History + driver_team_nation + age + anywins + anypoints + anypoles + 
...
Cox_mod_efron <- coxph(Surv(Data1_alt$sum_seasons_alt, Data1_alt$last_alt) ~ F2_GP2_F3000_champ +
                         children +
                         History + driver_team_nation + age + anywins + anypoints + anypoles + 
...
km_trt_titles <- survfit(Surv(Data1$sum_races, Data1$last)~Data1$anytitles)
autoplot(km_trt_titles) 

gehan.wilcoxon.test(Surv(Data1$sum_races, Data1$last)~Data1$anytitles, Data1, gehan = TRUE)
...
km_trt_wins <- survfit(Surv(Data1$sum_races, Data1$last)~Data1$anywins)
autoplot(km_trt_wins) 

gehan.wilcoxon.test(Surv(Data1$sum_races, Data1$last)~Data1$anywins, Data1, gehan = TRUE)
...
km_trt_poles <- survfit(Surv(Data1$sum_races, Data1$last)~Data1$anypoles)
autoplot(km_trt_poles) 

gehan.wilcoxon.test(Surv(Data1$sum_races, Data1$last)~Data1$anypoles, Data1, gehan = TRUE)
...
km_trt_podiums <- survfit(Surv(Data1$sum_races, Data1$last)~Data1$anypodiums)
autoplot(km_trt_podiums) 

gehan.wilcoxon.test(Surv(Data1$sum_races, Data1$last)~Data1$anypodiums, Data1, gehan = TRUE)
...
km_trt_points <- survfit(Surv(Data1$sum_races, Data1$last)~Data1$anypoints)
autoplot(km_trt_points) 

gehan.wilcoxon.test(Surv(Data1$sum_races, Data1$last)~Data1$anypoints, Data1, gehan = TRUE)
...
km_trt_history <- survfit(Surv(Data1$sum_races, Data1$last)~Data1$History)
autoplot(km_trt_history)

gehan.wilcoxon.test(Surv(Data1$sum_races, Data1$last)~Data1$History, Data1, gehan = TRUE)
...
km_trt_factory <- survfit(Surv(Data1$sum_races, Data1$last)~Data1$Factory)
autoplot(km_trt_factory)

gehan.wilcoxon.test(Surv(Data1$sum_races, Data1$last)~Data1$Factory, Data1, gehan = TRUE)
...
gehan.wilcoxon.test(Surv(Data1$sum_seasons, Data1$last)~Data1$F2_GP2_F3000_champ, Data1, gehan = TRUE)
#log-rank тест
survdiff(Surv(Data1$sum_seasons, Data1$last)~Data1$F2_GP2_F3000_champ, data = Data1)

km_trt_F2 <- survfit(Surv(Data1$sum_races, Data1$last)~Data1$F2_GP2_F3000_champ)
autoplot(km_trt_F2)

gehan.wilcoxon.test(Surv(Data1$sum_races, Data1$last)~Data1$F2_GP2_F3000_champ, Data1, gehan = TRUE)


#Спортивная династия (не значимо!)
...
km_trt_family <- survfit(Surv(Data1$sum_races, Data1$last)~Data1$Family_business)
autoplot(km_trt_family)

gehan.wilcoxon.test(Surv(Data1$sum_races, Data1$last)~Data1$Family_business, Data1, gehan = TRUE)
...
km_trt_nation <- survfit(Surv(Data1$sum_races, Data1$last)~Data1$driver_team_nation)
autoplot(km_trt_nation)

gehan.wilcoxon.test(Surv(Data1$sum_races, Data1$last)~Data1$driver_team_nation, Data1, gehan = TRUE)
...
km_trt_married <- survfit(Surv(Data1$sum_races, Data1$last)~Data1$married)
autoplot(km_trt_married)

gehan.wilcoxon.test(Surv(Data1$races_for_team, Data1$last)~Data1$married, Data1, gehan = TRUE)
...
km_trt_kids <- survfit(Surv(Data1$sum_races, Data1$last)~Data1$children)
autoplot(km_trt_kids)

gehan.wilcoxon.test(Surv(Data1$races_for_team, Data1$last)~Data1$children, Data1, gehan = TRUE)
...
km_trt_partner <- survfit(Surv(Data1$sum_races, Data1$last)~Data1$beatpartner)
autoplot(km_trt_partner)

gehan.wilcoxon.test(Surv(Data1$races_for_team, Data1$last)~Data1$beatpartner, Data1, gehan = TRUE)
...
summary(Aalen_mod, maxtime = 6)
summary(Aalen_mod, maxtime = 7)
summary(Aalen_mod, maxtime = 8)
summary(Aalen_mod, maxtime = 9)
summary(Aalen_mod, maxtime = 10)
summary(Aalen_mod, maxtime = 11)
summary(Aalen_mod, maxtime = 12)
summary(Aalen_mod, maxtime = 13)


autoplot(Aalen_mod)

View(Data1 %>% filter(F2_GP2_F3000_champ == 1) %>% dplyr::select(driverRef, sum_seasons) %>% arrange(desc(sum_seasons)))

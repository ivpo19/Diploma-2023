...
km_trt_F2 <- survfit(Surv(Data1_alt$races_for_team, Data1_alt$last_alt)~Data1_alt$F2_champ)
autoplot(km_trt_F2)

gehan.wilcoxon.test(Surv(Data1_alt$races_for_team, Data1_alt$last_alt)~Data1_alt$F2_champ, Data1_alt, gehan = TRUE)
...
km_trt_F2 <- survfit(Surv(Data1$sum_races, Data1$last)~Data1$F2_champ)
autoplot(km_trt_F2)

gehan.wilcoxon.test(Surv(Data1$sum_races, Data1$last)~Data1$F2_champ, Data1, gehan = TRUE)
